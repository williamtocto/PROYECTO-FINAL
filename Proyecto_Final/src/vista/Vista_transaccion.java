...
public class Vista_transaccion extends javax.swing.JInternalFrame {
    ...
    public JLabel getLblCantidad_cuenta() {
        return LblCantidad_cuenta;
    }

    public void setLblCantidad_cuenta(JLabel LblCantidad_cuenta) {
        this.LblCantidad_cuenta = LblCantidad_cuenta;
    }

    public JLabel getLblCedula_so() {
        return LblCedula_so;
    }

    public void setLblCedula_so(JLabel LblCedula_so) {
        this.LblCedula_so = LblCedula_so;
    }

    public JLabel getLblCodigo_socio() {
        return LblCodigo_socio;
    }

    public void setLblCodigo_socio(JLabel LblCodigo_socio) {
        this.LblCodigo_socio = LblCodigo_socio;
    }
    ...
    public JLabel getLblIngrese_monto() {
        return LblIngrese_monto;
    }

    public void setLblIngrese_monto(JLabel LblIngrese_monto) {
        this.LblIngrese_monto = LblIngrese_monto;
    }
    ...
    public JLabel getLblNume_cuenta() {
        return LblNume_cuenta;
    }

    public void setLblNume_cuenta(JLabel LblNume_cuenta) {
        this.LblNume_cuenta = LblNume_cuenta;
    }
    ...
    public JLabel getLblTipo_transa() {
        return LblTipo_transa;
    }
    ...
    public JLabel getLbldinerocaja() {
        return Lbldinerocaja;
    }

    public void setLbldinerocaja(JLabel Lbldinerocaja) {
        this.Lbldinerocaja = Lbldinerocaja;
    }
